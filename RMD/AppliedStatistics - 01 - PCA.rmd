...
Variables have to be continuous! If there are categorical data, get rid of them.
...
summary(pc.data)
```
Looking at the cumulative proportion: is it possible to perform dimensionality reduction?
